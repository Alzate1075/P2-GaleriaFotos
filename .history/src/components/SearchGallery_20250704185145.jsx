...
export default function SearchGallery({ buscarT, setBuscarT, buscarFotos }) {
  return (
    <div className="font-sans text-gray-500 flex items-center justify-center mt-12">
      ...
      <button
        onClick={buscarFotos}
        className="border-3 border-gray-300 md:border-0 cursor-pointer md:border-[#051b37] bg-[#051b37] md:bg-gray-100 text-white px-4 py-1 rounded-r hover:bg-[#051b37]"
      >
